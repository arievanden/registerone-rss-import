<?php
/**
 * Plugin Name: RegisterONE (WP-RSSImport)
 * Plugin URI:  https://www.registerone.com/vendor-rss-feeds
 * Text Domain: registerone-rssimport
 * Domain Path: /languages
 * Description: Display Feeds in your blog. Use the function <code>RSSImport()</code>, a Widget or the Shortcode <code>[RSSImport]</code>. Custom mods for RegisterONE.
 * Author:      Frank Bültge, took77, RegisterONE
 * Version:     1.0.0
 * License:     GPLv3+
 * Last change: 2018-2-28
 */
		...
		while ( $display < $displaylimit ) {
			...
			if ( array_key_exists( $i, $items ) ) {
				...
				if ( $use_simplepie && $displaydescriptions && $html ) {
                    $desc = "&lt;table &gt;&lt;tr&gt;&lt;th style='width: 400px; white-space: normal;'&gt;Business/Vendor Description for Program&lt;/th&gt;&lt;td&gt;Display gemstones &amp; crystals, gemstone jewelry, spiritual gifts&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;th style='width: 400px; white-space: normal;'&gt;Raffle Donation Information&lt;/th&gt;&lt;td&gt;$20 gemstone necklace&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;th style='width: 400px; white-space: normal;'&gt;Raffle Donation&lt;/th&gt;&lt;td&gt;Yes&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;th style='width: 400px; white-space: normal;'&gt;Presentation Proposals&lt;/th&gt;&lt;td&gt;No&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;th style='width: 400px; white-space: normal;'&gt;Vendor/Reader Description&lt;/th&gt;&lt;td&gt;Offering various beautiful gemstones and crystals for display, gemstone jewelry and spiritual gifts.&lt;/td&gt;&lt;/tr&gt;
&lt;tr&gt;&lt;th style='width: 400px; white-space: normal;'&gt;Booth Location&lt;/th&gt;&lt;td&gt;Same booth as last time (we have it on file)&lt;/td&gt;&lt;/tr&gt;&lt;/table&gt;";
				...
				$echo .= '<a style="font-size:large"' . $target . $rel . ' href="' . $href . '" title="' . $atitle . '" class="rss-vendor-title">' . $title . '</a>';
